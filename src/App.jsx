...
function IntroSection() {
  ...
  return (
    <div className={articleStyles.container}>
      ...
      <a href="https://www.techupth.com/" target="blank" className={articleStyles.body}>
        techupth.com
      </a>
      {/* ให้แสดงวันเวลาด้วย Function `getCurrentDateTime` ที่กำหนดไว้ให้ */}
      <div className="bootcamp-start-time">วันเวลาเริ่มหลักสูตร คือ (วันเวลา){getCurrentDateTime} </div>
